        ...
        if "training_data" in enhanced_data:
            ...
            if training_data is not None and not training_data.empty:
                ...
                if len(invalid_games) == 0:
                    print(
                        "✅ Filtering correct: All games have valid scores for both teams"
                    )
                else:
                    print(
                        f"⚠️  Warning: {len(invalid_games)} games with invalid scores found"
                    )
                ...
                if "season" in training_data.columns:
                    ...
                    print(
                        f"   2025 games: {len(training_data[training_data['season'] == 2025])}"
                    )
...
def validate_power_rankings():
    ...
    enhanced_data = {"training_data": mock_training}
