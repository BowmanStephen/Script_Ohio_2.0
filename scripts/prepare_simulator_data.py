...
def prepare_simulator_data():
    ...
    for game_entry in data.get("games", []):
        ...
        sim_game = {
            ...
            "home_points_per_opportunity_offense": info.get(
                "home_points_per_opportunity_offense"
            ),
            "away_points_per_opportunity_offense": info.get(
    ...
    print(
        f"Successfully generated {len(simulator_games)} games for the simulator at {output_path}"
    )
