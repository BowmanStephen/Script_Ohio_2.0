...
def prepare_week14_simulator_data():
    ...
    input_path = (
        repo_root / "data" / "training" / "weekly" / "training_data_2025_week14.csv"
    )
    ...
    for game in simulator_games:
        ...
        ts_content += (
            f'"home_adjusted_explosiveness": {game["home_adjusted_explosiveness"]}, '
        )
        ts_content += (
            f'"away_adjusted_explosiveness": {game["away_adjusted_explosiveness"]}, '
        )
