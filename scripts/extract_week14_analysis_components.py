...
def main():
    ...
    matchup_analysis = {
        ...
        "head_to_head": comprehensive.get("detailed_analysis", {}).get(
            "head_to_head", {}
        ),
        "team_strengths": comprehensive.get("detailed_analysis", {}).get(
            "team_strengths", {}
        ),
        "matchup_insights": comprehensive.get("detailed_analysis", {}).get(
            "matchup_insights", []
        ),
        "situational_factors": comprehensive.get("detailed_analysis", {}).get(
            "situational_factors", {}
        ),
        "advanced_stats": comprehensive.get("detailed_analysis", {}).get(
            "advanced_stats", {}
        ),
    }
    ...
    if validation_report_path.exists():
        ...
        model_validation = {
            ...
            "models_validated": validation_report.get("detailed_results", {}).get(
                "model_validation", {}
            ),
            "data_quality": validation_report.get("detailed_results", {}).get(
                "data_validation", {}
            ),
            "overall_status": validation_report.get("summary", {}).get(
