...
class RepositoryHealthValidator:
    ...
    def validate(self) -> Dict[str, Any]:
        ...
        if not clean_check["success"]:
            ...
            results["errors"].append(
                clean_check.get("error", "Working directory not clean")
            )
    ...
    def _check_working_directory(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if is_clean:
                return {"success": True, "message": "Working directory is clean"}
            else:
    ...
    def _check_protected_branch(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"branch": "unknown", "is_protected": False, "error": str(e)}
    ...
    def _check_secrets(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"secrets_found": False, "secrets": [], "error": str(e)}
