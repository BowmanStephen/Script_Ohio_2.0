...
try:
    ...
    from toon_format import _check_toon_cli, encode
...
class TestPlanValidation:
    ...
    def test_validate_missing_title_objective(self):
        ...
        invalid_plan = {"metadata": {}, "tasks": [], "steps": []}
    ...
    def test_validate_invalid_step_reference(self):
        ...
        invalid_plan = {
            "metadata": {"title": "Test", "objective": "Test"},
            "tasks": [{"id": "task_1", "name": "Task 1", "agent": "model"}],
            "steps": [{"id": "step_1", "task_id": "invalid_task", "action": "test"}],
        }
...
class TestWorkflowConversion:
    ...
    def test_convert_workflow_shared_inputs(self, sample_plan_data):
        ...
        sample_plan_data["shared_inputs"] = {"season": 2025, "week": 8}
