...
from src.models.execution.engine import FastAIInterface, ModelExecutionEngine
...
class TestModelExecutionEngineComprehensive:
    ...
    def model_engine(self, temp_workspace):
        ...
        return ModelExecutionEngine(
            agent_id="test_model_engine", base_path=temp_workspace
        )
    ...
    def mock_model_data(self):
        ...
        return {"ridge_model_2025": ridge_model, "xgb_home_win_model_2025": xgb_model}
    ...
    def test_game_prediction_with_mocked_model(self, model_engine, mock_model_data):
        ...
        # Mock interface
        mock_interface = Mock()
        mock_interface.predict.return_value = {"prediction": 7.5, "confidence": 0.8}
    ...
    def test_model_status_comprehensive_report(self, model_engine):
        ...
        with patch.object(model_engine, "_load_available_models") as mock_load:
            ...
            model_engine.models = {
                "ridge_model_2025": Mock(
                    name="ridge_model_2025",
                    model_type="regression",
                    features_required=[],
                ),
                "xgb_home_win_model_2025": Mock(
