...
class TestCFBDSmokeLive:
    ...
    def test_get_conferences_live(self, client):
        ...
        try:
            ...
            if strict_auth:
                ...
                pytest.skip(
                    f"CFBD API key invalid or expired: {e}. Update CFBD_API_KEY to run this test."
                )
    ...
    def test_host_config_live(self):
        ...
        config_prod = CFBDConfig(
            api_key=api_key, host="https://api.collegefootballdata.com"
        )
        ...
        config_next = CFBDConfig(
            api_key=api_key, host="https://apinext.collegefootballdata.com"
        )
    ...
    def test_error_handling_live(self, client):
        ...
        try:
            ...
            pytest.fail(
                "Expected CFBDNotFoundError for non-existent resource, but got result or no exception"
            )
    ...
    def test_graphql_scoreboard_live(self):
        ...
        result = agent._execute_action(
            "graphql_scoreboard", {"season": 2024, "week": 1}, {}
        )
