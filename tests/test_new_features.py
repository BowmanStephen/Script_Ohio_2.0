...
from src.features.offense_defense import (
    OffenseDefenseComparison,
    generate_matchup_comparison,
)
...
def test_drive_efficiency(mock_drives_df):
    ...
    explosive_rate = calculate_explosive_drive_rate(
        mock_drives_df, yards_threshold=10.0
    )
