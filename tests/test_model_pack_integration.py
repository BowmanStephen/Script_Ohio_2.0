...
class TestCompletePipeline:
    ...
    def mock_training_data(self):
        ...
        data = {
            "season": np.random.choice(
                [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024], n_games
            ),
            "week": np.random.randint(5, 15, n_games),
            "home_team": np.random.choice(
                ["Ohio State", "Michigan", "Alabama", "Georgia"], n_games
            ),
            "away_team": np.random.choice(
                ["Notre Dame", "Penn State", "Texas", "Oklahoma"], n_games
            ),
            ...
            "home_conference": np.random.choice(
                ["Big Ten", "SEC", "Big 12", "ACC"], n_games
            ),
            "away_conference": np.random.choice(
                ["Big Ten", "SEC", "Big 12", "ACC"], n_games
            ),
    ...
    def test_pipeline_with_missing_features(self, mock_training_data):
        ...
        incomplete_data = mock_training_data.drop(
            columns=["home_adjusted_epa", "away_adjusted_epa"]
        )
