...
class OffenseDefenseComparison:
    ...
    def normalize_matchup_metrics(
        self, offense_team: str, defense_team: str
    ) -> Dict[str, float]:
        """
...
def normalize_matchup_metrics(
    stats_df: pd.DataFrame, offense_team: str, defense_team: str
) -> Dict[str, float]:
...
def generate_matchup_comparison(
    stats_df: pd.DataFrame, team1: str, team2: str
) -> Dict[str, Any]:
