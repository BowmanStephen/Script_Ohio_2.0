...
Usage:
    CFBD_API_KEY=... python project_management/core_tools/fetch_2025_week12_data.py
"""
...
def main() -> None:
    ...
    config = cfbd.Configuration(access_token=api_key, host=CFBD_HOST)
