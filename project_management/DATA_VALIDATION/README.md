...
6. **Calculation Verification** 📐
   - Verifies EPA calculations match documented methodology
   - Validates opponent adjustments (subtraction-based)
   - Checks feature engineering consistency
   - Ensures temporal consistency (Week 5+)
