...
# Add the project root to path first
...
try:
    ...
    from agents.core.agent_framework import AgentFactory, RequestRouter, AgentRequest, PermissionLevel
    from agents.analytics_orchestrator import AnalyticsOrchestrator, AnalyticsRequest
except ImportError as e:
    print(f"❌ Error importing agent modules: {e}")
    agents_path = os.path.join(project_root, 'agents')
    agents_core_path = os.path.join(agents_path, 'core')
