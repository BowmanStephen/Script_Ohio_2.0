...
from src.visualization.dashboard import (
    create_metric_distribution_explorer,
    create_team_efficiency_dashboard,
)
...
class ReportGeneratorAgent(BaseAgent):
    ...
    def execute_task(
        self, parameters: Dict[str, Any], user_context: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
    ...
    def generate_weekly_report(
        ...
        try:
            ...
            if data is not None and not data.empty:
                try:
                    ...
                    if "offense_ppa" in data.columns and "defense_ppa" in data.columns:
                        ...
                        dashboard_path = (
                            self.output_dir / "team_efficiency_dashboard.html"
                        )
            ...
            with open(report_path, "w") as f:
                f.write(
                    f"<html><head><title>Week {self.week} Analysis</title></head><body>"
                )
