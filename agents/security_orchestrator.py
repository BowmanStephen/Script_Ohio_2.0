    ...
    def _define_capabilities(self) -> List[AgentCapability]:
        ...
        return [
            AgentCapability(
                ...
                tools_required=["auth_manager", "token_validator"],
                data_access=["user_credentials", "auth_logs", "session_data"],
            ),
            AgentCapability(
                ...
                data_access=["threat_level", "incidents"],
            ),
            AgentCapability(
            ...
            AgentCapability(
                ...
                data_access=["resolved", "resolution_details"],
            ),
            AgentCapability(
                ...
                data_access=["compliant", "violations", "score"],
            ),
            AgentCapability(
                name="audit_logging",
