...
class PromptLibraryAgent(BaseAgent):
    ...
    def _generate_prompt_library_entry(
...
def create_prompt_library_agent(
    agent_id: str = "prompt_library_generator",
) -> PromptLibraryAgent:
...
if __name__ == "__main__":
    ...
    if agent_file.exists():
        ...
        result = agent._execute_action(
            "generate_prompt_library_entry", {"agent_name": test_agent_name}, {}
        )
