    ...
    def _define_capabilities(self) -> List[AgentCapability]:
        ...
        return [
            AgentCapability(
                ...
                tools_required=["cfbd_client", "ppa_api"],
                data_access=["ppa_data", "team_stats"],
            ),
            AgentCapability(
                ...
                tools_required=["feature_engineer", "model_pipeline"],
                data_access=["training_data", "feature_matrix"],
            ),
            AgentCapability(
                ...
                tools_required=["data_validator", "quality_checker"],
                data_access=["validation_reports", "quality_metrics"],
            ),
            AgentCapability(
                ...
                permission_required=PermissionLevel.READ_EXECUTE_WRITE,
                tools_required=["prediction_engine", "model_serve"],
                data_access=["predictions", "model_outputs"],
            ),
            AgentCapability(
                ...
                permission_required=PermissionLevel.READ_EXECUTE,
                tools_required=["monitor", "metrics_collector"],
                data_access=["performance_metrics", "quality_dashboards"],
            ),
        ]
