...
class AdvancedMetricsAuthenticator:
    ...
    def _cfbd_host(self) -> str:
        return os.environ.get("CFBD_API_HOST", DEFAULT_HOST)

    def _session(self):
        return cfbd_session(host=self._cfbd_host())
    ...
    def _validate_ppa_metrics(self) -> Dict[str, Any]:
        ...
        try:
            with self._session() as session:
                ...
                try:
                    player_stats_api = session.players_api
